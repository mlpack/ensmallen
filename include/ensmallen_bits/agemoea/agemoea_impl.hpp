                               ...
                               const MatType& upperBound)
{
    ...
    MatType betaq2 = pow(us % alpha2, 1 / (eta + 1));
      ...
      const arma::Row<size_t>& extreme)
{
  ...
  MatType vectorizedObjectives(numObjectives, front.size());
  MatType vectorizedExtremes(numObjectives, extreme.n_elem);
