 ...
 * @author Marcus Edel
 *
 * A simple `randn` wrapper that based on the data type forwards to
 * `coot::randn` or `arma::randi`.
 *
 ...
 */
#ifndef ENSMALLEN_UTILITY_RANDN_HPP
#define ENSMALLEN_UTILITY_RANDN_HPP
