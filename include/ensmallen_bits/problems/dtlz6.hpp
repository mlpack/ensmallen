 ...
 *
 * Definition of the sixth DTLZ function.
 *
 ...
 */
#ifndef ENSMALLEN_PROBLEMS_DTLZ_SIX_HPP
#define ENSMALLEN_PROBLEMS_DTLZ_SIX_HPP

namespace ens {
namespace test {

/**
 * A class that represents the sixth DTLZ function.
 *
...
{
 public:
 	//! Initialize the DTLZ6 function.
 	DTLZ6(const size_t numVariables,
