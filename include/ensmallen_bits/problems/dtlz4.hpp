 ...
 *
 * Definition of the fourth DTLZ function.
 *
 ...
 */
#ifndef ENSMALLEN_PROBLEMS_DTLZ_FOUR_HPP
#define ENSMALLEN_PROBLEMS_DTLZ_FOUR_HPP

namespace ens {
namespace test {

/**
 * A class that represents the fourth DTLZ function.
 *
...
{
 public:
 	//! Initialize the DTLZ4 function.
 	DTLZ4(const size_t numVariables,
