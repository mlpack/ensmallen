 ...
 *
 * Definition of the third DTLZ function.
 *
 ...
 */
#ifndef ENSMALLEN_PROBLEMS_DTLZ_THREE_HPP
#define ENSMALLEN_PROBLEMS_DTLZ_THREE_HPP

namespace ens {
namespace test {

/**
 * A class that represents the third DTLZ function.
 *
...
{
 public:
 	//! Initialize the DTLZ3 function.
 	DTLZ3(const size_t numVariables,
