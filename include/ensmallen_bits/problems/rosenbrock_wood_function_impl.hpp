...
RosenbrockWoodFunction<MatType, LabelsType>::RosenbrockWoodFunction() :
    rf(4), wf()
{
...
template<typename MatType, typename LabelsType>
void RosenbrockWoodFunction<MatType, LabelsType>::Shuffle()
{ /* Nothing to do here */ }

template<typename MatType, typename LabelsType>
typename MatType::elem_type RosenbrockWoodFunction<
...
void RosenbrockWoodFunction<MatType, LabelsType>::Gradient(
    const MatType& coordinates,
    const size_t /* begin */,
    GradType& gradient,
    const size_t /* batchSize */) const
...
template<typename MatType, typename LabelsType>
template<typename GradType>
inline void RosenbrockWoodFunction<MatType, LabelsType>::Gradient(
