...
We ran our code on a {\tt MacBook Pro i7 2018, 16GB RAM} running {\tt macOS 10.14} with clang {\tt 1000.10.44.2}, Julia version {\tt 1.0.1}, Python {\tt 2.7.15}, and Octave {\tt 4.4.1}.
...
{\tt ensmallen}-1 & {\bf 0.001s} & {\bf 0.009s} & {\bf 0.154s} & {\bf 2.215s} \\
{\tt ensmallen}-2 & 0.002s & 0.016s & 0.182s & 2.522s \\
% Dropped for space and awful performance
%{\tt Calculus.jl} & 0.172s & 0.960s & 27.428s & 2535.507s \\
{\tt Optim.jl} & 0.006s & 0.030s & 0.337s & 4.271s \\
{\tt scipy} & 0.003s & 0.017s & 0.202s & 2.729s \\
{\tt bfgsmin} & 0.071s & 0.859s & 23.220s & 2859.81s\\
...
{\tt ForwardDiff.jl} & 0.497s & 1.159s & 4.996s & 603.106s \\
{\tt autograd} & 0.007s & 0.026s & 0.210s & 2.673s \\
\bottomrule
\end{tabular}
\end{adjustbox}
\vspace*{0.25ex}
