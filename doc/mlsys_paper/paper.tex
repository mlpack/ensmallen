...
between optimizers. In Fig.~\ref{fig:learning_curve} we use these six
...
functions can be dropped into place.
...
\begin{minipage}{0.38\textwidth}
  ...
  \caption
    {
    Learning curves for six {\tt ensmallen} optimizers 
    for optimizing a linear regression function 
    on the {\tt YearPredictionMSD} dataset~\cite{ucimlrepository}
    over 5 epochs of training.
    Optimizers can be tuned for better performance.
    }
