...
First, we consider the simple and popular Rosenbrock function: % TODO: cite
...
\begin{itemize}
  \item {\tt ensmallen}
  \item {\tt scipy.optimize.anneal}, from scipy 0.14.1 % TODO: cite
  \item {\tt Optim.jl}'s simulated annealing implementation with Julia 1.0.1
% TODO: cite
  \item {\tt samin} from GNU Octave's {\tt optim} package % TODO: cite
