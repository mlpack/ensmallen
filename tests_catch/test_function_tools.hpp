                                       ...
                                       arma::Row<size_t>& shuffledResponses)
{
  ...
  for (size_t i = 0; i < 500; ++i)
  {
    ...
    data.col(i) = 3 * arma::randn<arma::vec>(3) + arma::vec("1.0 1.0 1.0");
    responses[i] = 0;
  }
  for (size_t i = 500; i < 1000; ++i)
  {
    // The second Gaussian is centered at (9, 9, 9) and has covariance 3*I.
    data.col(i) = 3 * arma::randn<arma::vec>(3) + arma::vec("9.0 9.0 9.0");
    responses[i] = 1;
  }
  ...
  for (size_t i = 0; i < 500; ++i)
  {
    testData.col(i) = 3 * arma::randn<arma::vec>(3) + arma::vec("1.0 1.0 1.0");
    testResponses[i] = 0;
  }
  for (size_t i = 500; i < 1000; ++i)
  {
    testData.col(i) = 3 * arma::randn<arma::vec>(3) + arma::vec("9.0 9.0 9.0");
    testResponses[i] = 1;
  }
}
