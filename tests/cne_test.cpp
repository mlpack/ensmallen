...
TEMPLATE_TEST_CASE("CNE_CrossInTrayFunction", "[CNE]", arma::mat)
{
...
TEMPLATE_TEST_CASE("CNE_AckleyFunction", "[CNE]", arma::mat)
{
  CNE optimizer(450, 1500, 0.3, 0.3, 0.3, -1);
  FunctionTest<AckleyFunction>(optimizer, 0.5, 0.1);
}

TEMPLATE_TEST_CASE("CNE_BealeFunction", "[CNE]", arma::mat)
{
  CNE optimizer(450, 1500, 0.3, 0.3, 0.3, -1);
  FunctionTest<BealeFunction>(optimizer, 0.5, 0.1);
}

TEMPLATE_TEST_CASE("CNE_GoldsteinPriceFunction", "[CNE]", arma::mat)
{
  CNE optimizer(450, 1500, 0.3, 0.3, 0.1, -1);
  FunctionTest<GoldsteinPriceFunction>(optimizer, 0.5, 0.1);
}

TEMPLATE_TEST_CASE("CNE_LevyFunctionN13", "[CNE]", arma::mat)
{
  CNE optimizer(450, 1500, 0.3, 0.3, 0.02, -1);
  FunctionTest<LevyFunctionN13>(optimizer, 0.5, 0.1);
}

TEMPLATE_TEST_CASE("CNE_HimmelblauFunction", "[CNE]", arma::mat)
{
...
TEMPLATE_TEST_CASE("CNE_ThreeHumpCamelFunction", "[CNE]", arma::mat)
{
  CNE optimizer(450, 1500, 0.3, 0.3, 0.3, -1);
 ...
 */
TEMPLATE_TEST_CASE("CNE_SchafferFunctionN4", "[CNE]", arma::mat)
{
...
TEMPLATE_TEST_CASE("CNE_SchafferFunctionN2", "[CNE]", arma::mat)
{
