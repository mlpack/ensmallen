 ...
 */
 ...
 TEMPLATE_TEST_CASE("Adam_SphereFunction", "[Adam]", arma::sp_mat)
 {
   typedef typename TestType::elem_type ElemType;

   SphereFunctionType<arma::mat, arma::Row<size_t>> f(2);
   Adam optimizer(0.5, 2, 0.7, 0.999, 1e-8, 50000, 1e-3, false);
 ...
 TEMPLATE_TEST_CASE("AMSGrad_SphereFunction", "[Adam]", arma::sp_mat)
 {
   AMSGrad optimizer(1e-3, 1, 0.9, 0.999, 1e-8, 50000, 1e-11, true);
   FunctionTest<SphereFunctionType<TestType, arma::Row<size_t>>, TestType>(
       optimizer, 0.5, 0.1);
 ...
 TEMPLATE_TEST_CASE("QHAdam_LogisticRegressionFunction", "[Adam]", arma::sp_mat)
 {
   QHAdam optimizer;
   LogisticRegressionFunctionTest<TestType>(optimizer, 0.003, 0.006);
 }
